 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://PROYECTOWS/", wsdlLocation = "http://localhost:8080/ProyectoHotelAD/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://PROYECTOWS/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ProyectoHotelAD/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://PROYECTOWS/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://PROYECTOWS/", "NewWebServicePort"), NewWebService.class, features);
    }
