...
import Constructores.habitacionlista;
import Constructores.reservalista;

/**
 *
 * @author Yutokiva
 */
@WebServlet(name = "ingresarreservafi", urlPatterns = {"/ingresarreservafi"})
public class ingresarreservafi extends HttpServlet {
