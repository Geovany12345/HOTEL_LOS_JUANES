          ...
          <div class="row g-0">
            ...
            <div class="col-md-10 col-lg-10 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg btn-block" onclick="location.href='IngresarResrva.jsp'" >Ingresar Reserva</button>
                  </div>
                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg btn-block" onclick="location.href='mostrarreserva.jsp'" >Mostrar Reserva</button>
                  </div>
                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg btn-block" onclick="location.href='modificarreserva1.jsp'">Modificar Reserva</button>
                  </div>
                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg btn-block" onclick="location.href='eliminarreserva1.jsp'">Eliminar Reserva</button>
                  </div>
